...
DROP POLICY IF EXISTS "Anyone can view airbnbs" ON airbnbs;
...
((SELECT id FROM destinations WHERE name = 'Maasai Mara National Reserve, Kenya'), 'Maasai Mara Classic Safari', 'Experience the thrill of the Maasai Mara with game drives and cultural encounters.', 3, 200000.00, 6, 'https://images.unsplash.com/photo-1547471080-7cc8555ca1f7?w=800', ARRAY['https://images.unsplash.com/photo-1547471080-7cc8555ca1f7?w=800'], ARRAY['Accommodation', 'Meals', 'Game Drives', 'Maasai Village Visit'], '[{"day": 1, "activities": ["Arrival and transfer to lodge", "Afternoon game drive"]}, {"day": 2, "activities": ["Full day game drive", "Maasai village visit"]}, {"day": 3, "activities": ["Morning game drive", "Departure"]}]'),
((SELECT id FROM destinations WHERE name = 'Serengeti National Park, Tanzania'), 'Serengeti Migration Safari', 'Witness the Great Migration in the Serengeti plains.', 4, 250000.00, 8, 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800', ARRAY['https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800'], ARRAY['Accommodation', 'Meals', 'Game Drives', 'Hot Air Balloon'], '[{"day": 1, "activities": ["Arrival in Arusha", "Transfer to Serengeti"]}, {"day": 2, "activities": ["Game drives"]}, {"day": 3, "activities": ["Hot air balloon safari"]}, {"day": 4, "activities": ["Departure"]}]'),
((SELECT id FROM destinations WHERE name = 'Amboseli National Park, Kenya'), 'Amboseli Elephant Safari', 'Focus on elephant herds with Kilimanjaro backdrop.', 2, 150000.00, 6, 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800', ARRAY['https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800'], ARRAY['Accommodation', 'Meals', 'Game Drives'], '[{"day": 1, "activities": ["Arrival", "Game drive"]}, {"day": 2, "activities": ["Full day safari", "Departure"]}]'),
((SELECT id FROM destinations WHERE name = 'Ngorongoro Crater, Tanzania'), 'Ngorongoro Crater Tour', 'Explore the crater floor with diverse wildlife.', 1, 120000.00, 6, 'https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=800', ARRAY['https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=800'], ARRAY['Game Drive', 'Meals'], '[{"day": 1, "activities": ["Crater tour", "Return"]}'),
((SELECT id FROM destinations WHERE name = 'Tsavo National Park, Kenya'), 'Tsavo Adventure Safari', 'Experience the wild Tsavo with its unique landscapes.', 3, 180000.00, 8, 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800', ARRAY['https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800'], ARRAY['Accommodation', 'Meals', 'Game Drives'], '[{"day": 1, "activities": ["Arrival", "Game drive"]}, {"day": 2, "activities": ["Full day safari"]}, {"day": 3, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Kruger National Park, South Africa'), 'Kruger Big Five Safari', 'Self-drive safari in search of the Big Five.', 5, 280000.00, 4, 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=800', ARRAY['https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=800'], ARRAY['Accommodation', 'Meals', 'Self-Drive Vehicle'], '[{"day": 1, "activities": ["Arrival", "Orientation"]}, {"day": 2-4, "activities": ["Self-drive safaris"]}, {"day": 5, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Queen Elizabeth National Park, Uganda'), 'Queen Elizabeth Wildlife Tour', 'Boat safari and chimp tracking.', 3, 220000.00, 6, 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800', ARRAY['https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800'], ARRAY['Accommodation', 'Meals', 'Boat Safari', 'Chimp Tracking'], '[{"day": 1, "activities": ["Arrival", "Game drive"]}, {"day": 2, "activities": ["Boat safari", "Chimp tracking"]}, {"day": 3, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Bwindi Impenetrable Forest, Uganda'), 'Bwindi Gorilla Trek', 'Trek to see mountain gorillas in the mist.', 2, 350000.00, 8, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800', ARRAY['https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800'], ARRAY['Accommodation', 'Meals', 'Gorilla Permits', 'Guide'], '[{"day": 1, "activities": ["Arrival", "Briefing"]}, {"day": 2, "activities": ["Gorilla trek", "Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Akagera National Park, Rwanda'), 'Akagera Safari Experience', 'Savanna wildlife and boat safaris.', 3, 200000.00, 6, 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800', ARRAY['https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800'], ARRAY['Accommodation', 'Meals', 'Game Drives', 'Boat Safari'], '[{"day": 1, "activities": ["Arrival", "Game drive"]}, {"day": 2, "activities": ["Boat safari"]}, {"day": 3, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Chobe National Park, Botswana'), 'Chobe Elephant Safari', 'Focus on elephants and river wildlife.', 4, 300000.00, 8, 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800', ARRAY['https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800'], ARRAY['Accommodation', 'Meals', 'Game Drives', 'Boat Safari'], '[{"day": 1, "activities": ["Arrival"]}, {"day": 2-3, "activities": ["Safaris"]}, {"day": 4, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Etosha National Park, Namibia'), 'Etosha Wildlife Safari', 'Waterhole game viewing.', 3, 250000.00, 6, 'https://images.unsplash.com/photo-1547471080-7cc8555ca1f7?w=800', ARRAY['https://images.unsplash.com/photo-1547471080-7cc8555ca1f7?w=800'], ARRAY['Accommodation', 'Meals', 'Game Drives'], '[{"day": 1, "activities": ["Arrival"]}, {"day": 2, "activities": ["Game drives"]}, {"day": 3, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Okavango Delta, Botswana'), 'Okavango Delta Adventure', 'Mokoro canoe safaris in the delta.', 5, 400000.00, 6, 'https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=800', ARRAY['https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=800'], ARRAY['Accommodation', 'Meals', 'Mokoro Safari', 'Walking Safaris'], '[{"day": 1, "activities": ["Arrival"]}, {"day": 2-4, "activities": ["Delta activities"]}, {"day": 5, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Hluhluwe-Imfolozi Park, South Africa'), 'Hluhluwe Rhino Safari', 'Rhino conservation and Big Five.', 3, 220000.00, 8, 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=800', ARRAY['https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=800'], ARRAY['Accommodation', 'Meals', 'Game Drives'], '[{"day": 1, "activities": ["Arrival"]}, {"day": 2, "activities": ["Safaris"]}, {"day": 3, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Murchison Falls National Park, Uganda'), 'Murchison Falls Tour', 'Falls and Nile wildlife.', 3, 200000.00, 6, 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800', ARRAY['https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800'], ARRAY['Accommodation', 'Meals', 'Boat Safari', 'Game Drives'], '[{"day": 1, "activities": ["Arrival"]}, {"day": 2, "activities": ["Boat safari"]}, {"day": 3, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Zimbabwe''s Mana Pools, Zimbabwe'), 'Mana Pools Wilderness', 'Wild camping and wildlife.', 4, 280000.00, 6, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800', ARRAY['https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800'], ARRAY['Accommodation', 'Meals', 'Guided Walks'], '[{"day": 1, "activities": ["Arrival"]}, {"day": 2-3, "activities": ["Wilderness activities"]}, {"day": 4, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Moremi Game Reserve, Botswana'), 'Moremi Delta Safari', 'Diverse delta wildlife.', 4, 320000.00, 8, 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800', ARRAY['https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800'], ARRAY['Accommodation', 'Meals', 'Mokoro', 'Walking Safaris'], '[{"day": 1, "activities": ["Arrival"]}, {"day": 2-3, "activities": ["Delta safaris"]}, {"day": 4, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Ruaha National Park, Tanzania'), 'Ruaha Leopard Safari', 'Leopard-focused safari.', 3, 250000.00, 6, 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800', ARRAY['https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800'], ARRAY['Accommodation', 'Meals', 'Game Drives'], '[{"day": 1, "activities": ["Arrival"]}, {"day": 2, "activities": ["Leopard tracking"]}, {"day": 3, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Selous Game Reserve, Tanzania'), 'Selous Boat Safari', 'Boat safaris on the Rufiji River.', 4, 220000.00, 8, 'https://images.unsplash.com/photo-1547471080-7cc8555ca1f7?w=800', ARRAY['https://images.unsplash.com/photo-1547471080-7cc8555ca1f7?w=800'], ARRAY['Accommodation', 'Meals', 'Boat Safaris', 'Walking Safaris'], '[{"day": 1, "activities": ["Arrival"]}, {"day": 2-3, "activities": ["River safaris"]}, {"day": 4, "activities": ["Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Virunga National Park, DRC'), 'Virunga Gorilla Trek', 'Mountain gorilla trekking.', 2, 450000.00, 6, 'https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=800', ARRAY['https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=800'], ARRAY['Accommodation', 'Meals', 'Gorilla Permits'], '[{"day": 1, "activities": ["Arrival"]}, {"day": 2, "activities": ["Gorilla trek", "Departure"]}'),
((SELECT id FROM destinations WHERE name = 'Kgalagadi Transfrontier Park, South Africa/Botswana'), 'Kgalagadi Desert Safari', 'Dune and desert wildlife.', 3, 280000.00, 6, 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=800', ARRAY['https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=800'], ARRAY['Accommodation', 'Meals', 'Game Drives'], '[{"day": 1, "activities": ["Arrival"]}, {"day": 2, "activities": ["Desert safaris"]}, {"day": 3, "activities": ["Departure"]}');
...
((SELECT id FROM destinations WHERE name = 'Maasai Mara National Reserve, Kenya'), 'Mara Serena Safari Lodge', 'Luxury lodge overlooking the Mara River.', 50000.00, 4.5, 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800', ARRAY['https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800'], ARRAY['WiFi', 'Pool', 'Restaurant', 'Laundry']),
((SELECT id FROM destinations WHERE name = 'Serengeti National Park, Tanzania'), 'Serengeti Serena Safari Lodge', 'Comfortable lodge in the heart of the Serengeti.', 45000.00, 4.3, 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800', ARRAY['https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800'], ARRAY['WiFi', 'Pool', 'Restaurant', 'Bar']),
((SELECT id FROM destinations WHERE name = 'Amboseli National Park, Kenya'), 'Amboseli Serena Safari Lodge', 'Views of Kilimanjaro from every room.', 40000.00, 4.4, 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800', ARRAY['https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800'], ARRAY['WiFi', 'Pool', 'Restaurant', 'Spa']),
((SELECT id FROM destinations WHERE name = 'Ngorongoro Crater, Tanzania'), 'Ngorongoro Serena Safari Lodge', 'Perched on the crater rim.', 35000.00, 4.2, 'https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=800', ARRAY['https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=800'], ARRAY['WiFi', 'Restaurant', 'Bar']),
((SELECT id FROM destinations WHERE name = 'Tsavo National Park, Kenya'), 'Tsavo Safari Lodge', 'Rustic lodge in Tsavo East.', 30000.00, 4.0, 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800', ARRAY['https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800'], ARRAY['WiFi', 'Restaurant', 'Bar']),
((SELECT id FROM destinations WHERE name = 'Kruger National Park, South Africa'), 'Kruger Shalati Train', 'Luxury train accommodation.', 60000.00, 4.7, 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=800', ARRAY['https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=800'], ARRAY['WiFi', 'Restaurant', 'Bar', 'Spa']),
((SELECT id FROM destinations WHERE name = 'Queen Elizabeth National Park, Uganda'), 'Queen Elizabeth Safari Lodge', 'Overlooking the Kazinga Channel.', 34000.00, 4.1, 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800', ARRAY['https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800'], ARRAY['WiFi', 'Pool', 'Restaurant']),
((SELECT id FROM destinations WHERE name = 'Bwindi Impenetrable Forest, Uganda'), 'Bwindi Lodge', 'Eco-lodge near the forest.', 32000.00, 4.3, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800', ARRAY['https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800'], ARRAY['WiFi', 'Restaurant', 'Bar']),
