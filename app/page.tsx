            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 mb-8 border border-white/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <select className="w-full px-3 py-2 bg-white/20 border border-white/30 rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-amber-400">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 bg-white/20 border border-white/30 rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-amber-400">
                    ...
                    <option value="tours">Safari Tours</option>
                    <option value="hotels">Luxury Lodges</option>
                    <option value="airbnbs">Airbnb Stays</option>
                  </select>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-200 mb-2">Max Price (KES)</label>
                  <input
                    type="number"
                ...
                <div className="flex items-end">
                  <button className="w-full px-6 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg font-medium transition-colors">
                    Search
                  </button>
                </div>
              </div>
